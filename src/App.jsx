  ...
  >
    ...
    <g mask="url(#mask0_5084_12607)">
      <path
        ...
        fill="#4589FF" // Default fill color from the original SVG
      />
    </g>
  </svg>
);
  ...
  >
    ...
    <g mask="url(#mask0_5084_12612)">
      <path
        ...
        fill="#009859" // Default fill color from the original SVG
      />
    </g>
  </svg>
);
  ...
  >
    ...
    <g mask="url(#mask0_5084_12617)">
      <path
        ...
        fill="#DF0000" // Default fill color from the original SVG
      />
    </g>
  </svg>
);
...
const WarningIconNew = (props) => (
  ...
  >
    <path
      ...
      fill="#FCBD06" // Default fill color from the original SVG
    />
  </svg>
);
